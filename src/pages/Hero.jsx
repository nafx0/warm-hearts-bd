...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Parallax Content */}
      <Parallax speed={30} className="relative z-10 text-center px-4 py-20 sm:py-28 max-w-6xl w-full">
        {/* Badge */}
        <div className="inline-flex items-center bg-gradient-to-r from-amber-500 to-amber-600 text-white px-5 py-2 rounded-full mb-6 shadow-md">
          ...
          <span className="font-semibold tracking-wide">Compassion in Action</span>
        </div>
        ...
        <p className="text-base md:text-lg text-white/90 max-w-3xl mx-auto mb-10 leading-relaxed">
          Connecting compassionate donors with communities in need, ensuring warmth and dignity
          through the harsh Bangladeshi winters.
        </p>
